...
var linkAudit = {
    ...
    updateBadge:function(){
        ...
        ctx.roundRect(0, 0, 19, 19, 3, true, false);
        ctx.fillStyle = "rgba(150,150,150,0.7)";
        ctx.fill();

        if (linkAudit.toArray("contentStrings").length && linkAudit.getLocalStore("checkType") === "GET"){

            ctx.roundRect(2, 8, 4, 8, 2, true, false);
            ctx.fillStyle = "rgba(200,0,0,1)";
            ctx.fill();

            ctx.roundRect(7, 3, 4, 13, 2, true, false);
            ctx.fillStyle = "rgba(0,200,0,1)";
            ctx.fill();//rgba(255,204,0,1)

            ctx.roundRect(13, 10, 4, 6, 2, true, false);
            ctx.fillStyle = "rgba(255,204,0,1)";
            ctx.fill();//rgba(255,204,0,1)
        } else {
            ctx.roundRect(2, 8, 7, 8, 2, true, false);
            ctx.fillStyle = "rgba(255,0,0,1)";
            ctx.fill();

            ctx.roundRect(10, 3, 7, 13, 2, true, false);
