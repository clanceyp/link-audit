    ...
    content:{
        ...
        reDraw:function(setup){
            ...
            if (linkAudit.ctxPendingHeight > 0){
                ctx.save();
                linkAudit.content.drawBox(ctx, 10, (ctxHEIGHT-linkAudit.ctxPendingHeight-8), (ctxWIDTH-20), (linkAudit.ctxPendingHeight), 5, true, false, "rgba(80,80,80,0.8)");
                ctx.restore();
            } else {
                ctx.save();
                linkAudit.content.drawBox(ctx, 10, (ctxHEIGHT-8), (ctxWIDTH-20), 4, 2, true, false, "rgba(80,80,80,0.8)");
                ctx.restore();
            }
