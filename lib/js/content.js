...
var linkAudit = {
	...
	content:{
        ...
        updateDisplay:function(linkArray){
            ...
            if (cols === 4){
                $("#CE-linkAuditDisplay-status span").eq(0).text(contentMatched);
                $("#CE-linkAuditDisplay-status span").eq(1).text(failed);
                $("#CE-linkAuditDisplay-status span").eq(2).text(okay);
                $("#CE-linkAuditDisplay-status span").eq(3).text(queued);
            } else {
                $("#CE-linkAuditDisplay-status span").eq(0).text(failed);
                $("#CE-linkAuditDisplay-status span").eq(1).text(okay);
                $("#CE-linkAuditDisplay-status span").eq(2).text(queued);
            }
