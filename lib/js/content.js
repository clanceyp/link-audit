...
var linkAudit = {
	...
	content:{
        ...
        updateDisplay:function(linkArray){
            ...
            if (cols === 4){
                $("#CE-linkAuditDisplay-status span").eq(0).html("Matched<br/>" + contentMatched);
                $("#CE-linkAuditDisplay-status span").eq(1).html("Failed<br/>" + failed);
                $("#CE-linkAuditDisplay-status span").eq(2).html("Okay<br/>" + okay);
                $("#CE-linkAuditDisplay-status span").eq(3).html("Queued<br/>" + queued);
            } else {
                $("#CE-linkAuditDisplay-status span").eq(0).html("Failed<br/>" + failed);
                $("#CE-linkAuditDisplay-status span").eq(1).html("Okay<br/>" + okay);
                $("#CE-linkAuditDisplay-status span").eq(2).html("Queued<br/>" + queued);
            }
